...
func NewSkillsLoader(workspace string, globalSkills string, builtinSkills string) *SkillsLoader {
	return &SkillsLoader{
		...
		globalSkills:    globalSkills, // ~/.localagent/skills
...
func (sl *SkillsLoader) ListSkills() []SkillInfo {
	...
	// global skills (~/.localagent/skills) - overridden by workspace skills
	if sl.globalSkills != "" {
...
func (sl *SkillsLoader) LoadSkill(name string) (string, bool) {
	// 1. workspace skills first (project-level)
	if sl.workspaceSkills != "" {
	...
	// 2. global skills (~/.localagent/skills)
	if sl.globalSkills != "" {
